...
--
-- strategy:
-- 		mapjoin the norm values
-- 		remember to use doubles, or whatever, these numbers get crazy
-- 		use temp tables 
-- 		
-- 		results_auth
-- 		results_hub
-- 			* needs to be ordered by name, asc
-- 			* has (name, auth1, auth2, etc.)
-- 
-- 		temp_auth
-- 		temp_hub
-- 			* initially filter to remove any non-values, inner join should do it 
-- 			* needs to be ordered by name, asc
-- 			* has (name, auth)
--
-- 		norm_auth
...
--		(start algo)
--
-- 		create initial temp_auth
-- 			* use select distinct, ordered of right side of edge table
-- 			* all values is 1
-- 		create initial temp_hub
-- 			* use select distinct, ordered of left side of edge table
-- 
-- 		use these two to create results tables
-- 		
-- 		(start iteration)
--
-- 		update hub/auth via
-- 			* join temp_hub/auth with edges, group by, sum
--
-- 		normalize via
-- 			* update normal table 
-- 			* mapjoin with temp_auth/hub, divide value with norm
-- 			* then update/replace temp_auth/hub
-- 
-- 		update results
-- 			* add column
-- 			* insert data into column from temp_auth/hub
-- 
-- 		(end iteration)
-- 
-- 		save results to disk somewhere
